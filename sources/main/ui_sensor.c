...
#define COLOR_LIGHT lv_color_make(0, 200, 0)
#define COLOR_THEME lv_color_make(0, 199, 0)

//vycet stranek - defaultne na mems
typedef enum {
    ui_item_mems = 0,
    ui_item_temp_humid,
    ui_item_als,
...
/* Image declaration */
//obrazky deklarovany ve slozce /icon
...
void ui_sensor_init_1(void)
{
    lv_port_sem_take();
    
    //=======================
    obj_temp_humid = ui_create_obj(lv_scr_act(), 300, 100, "Temp a Humid");
